...
public final class PlayerDataCollector {
    ...
    public static String collectJsonLine() {
        ...
        root.addProperty("mcVersion", "1.21.11");
        ...
        p.addProperty("dimension", level.dimension().toString());
        ...
        p.addProperty("selectedSlot", inv.getSelectedSlot());
    ...
    private static JsonObject effectToJson(MobEffectInstance effect) {
        JsonObject obj = new JsonObject();
        obj.addProperty("id", effect.getEffect().unwrapKey()
                .map(Object::toString)
                .orElse("unknown"));
